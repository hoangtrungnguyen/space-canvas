...
status: readyForDev
epic: CONN-002
phase: Phase 5: UI Controls (1-2 days)
effort: 0.5 days
...
**Affected Modules:**
  - `lib/features/space/view/widgets/toolbar/
...
### Title
Add toolbar button for connector type
...
- `lib/features/space/view/widgets/toolbar/connector_type_button.dart`
